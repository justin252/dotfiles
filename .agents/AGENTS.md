...
- `review` – Codex code review for any PR or branch. `review` (auto-detect), `review 123` (PR), `review --json` (machine output). Always async; writes `review.md` to auto-discovered topic dir, notifies on completion.
